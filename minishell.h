...
/*   Updated: 2024/06/24 14:18:57 by mabbadi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define FREE_OPEN 31
# define FREE_FORK 32
// take a new number each case, incase I add to ft_error as a condition!!!!
# define EX_ARG 20 
# define CD_ARG 21
# define CD_HOME 23
# define CD_PWD 24
...
int						expen_helper(t_data *data, char *str, t_env *env_list,
							int size);
void					store_remaining(t_data *data, char *str,
							t_env *env_list);
...
// Builtins
int						exec_builtin_parent(t_data *data, char **cmd,
							t_env *env_list);
int						exec_builtin_child(t_data *data, char **cmd,
							t_env *env_list);
...
void					adv_error(t_data *data, const char *msg, int fd,
							int flag);
#endif
